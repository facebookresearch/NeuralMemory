...
def extract_target(agent_memory, db_dump):
    ...
    for task_mem in task_mems:
        if task_mem.action_name == "move":
            ...
            _, objs = agent_memory.basic_search("SELECT MEMORY FROM ReferenceObject WHERE eid={}".format(task_mem.task.eid))
...
if __name__ == "__main__":
    ...
    encoder = DBEncoder(query_encode=opts.query_encode,
                        SL=opts.SL,

...
def linearize_and_encode(lf, text_tokenizer, key_coder):
    ...
    """
    o = {"encoded": [], "text_spans": [], "coordinate_spans": [], "number_spans": []}
    if type(lf) is list:
...
if __name__ == "__main__":
    from training.utils.tokenizer import LFKeyCoder
    ...
    distance_lf = {
        ...
        "source": {
            "reference_object": {"special_reference": {"coordinates_span": pos}}
        },
    }
    clause = {
